...
<body>
	<div style="padding: 10px;">
		<form action="${pageContext.request.contextPath }/dimension/list.action" method="post">
			<select class="form-control wid" name="id" id="la">
			...
			<a id="addDimensionLink" href="#" class="button">
			<input class="btn btn-warning" style="margin-left: 10px;margin-bottom: 3px" type="button" name="create" value= "添加性格维度"
			onclick="add()"/>
			</a>
		</form>
		<script type="text/javascript" language="JavaScript">
			function add() {
				var selectElement = document.getElementById('la');
				var selectedValue = selectElement.value;
				var baseUrl = "${pageContext.request.contextPath}/dimension/create.action?id=";
				var fullUrl = baseUrl + selectedValue;
				document.getElementById('addDimensionLink').href = fullUrl;
			}
		</script>
