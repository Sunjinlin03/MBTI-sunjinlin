...
public class User extends BaseEntity {
    ...
    static {
        addDesc(com.qst.pojo.User.class,"s0","禁用","s1","正常","t1","用户管理员","t2","题库管理员","t3","题库使用者");
    }

    public String getTypeDesc(){
        return getDesc(com.qst.pojo.User.class,"t",type);
    }

    public String getStatusDesc(){
        return getDesc(com.qst.pojo.User.class,"s",status);
    }
